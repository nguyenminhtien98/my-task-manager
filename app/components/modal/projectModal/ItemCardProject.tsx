...
const ItemCardProject: React.FC<ItemCardProjectProps> = ({ data, onClick }) => {
  ...
  return (
    <button
      ...
      className="group block w-[130px] flex-shrink-0 transform rounded-lg border border-black/10 bg-transparent text-left transition-all hover:-translate-y-[2px] focus:outline-none"
